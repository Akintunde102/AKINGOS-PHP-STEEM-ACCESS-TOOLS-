...
class SteemApi
{
	...
	public function getAccountTotal($params, $transport='curl'){
	    $result = $this->SteemLayer->call('get_account_count', $params, $transport);
        return $result;
    }
	
	public function getIntendingWitnessCount($params, $transport='curl'){
	    $result = $this->SteemLayer->call('get_witness_count', $params, $transport);
        return $result;
    }
	
	public function getDiscussionsByActive($params, $transport='curl'){
	    $result = $this->SteemLayer->call('get_discussions_by_hot', $params, $transport);
        return $result;
    }
	
	public function getActiveWitness($params, $transport='curl'){
	    $result = $this->SteemLayer->call('get_active_witnesses', $params, $transport);
        return $result;
    }
